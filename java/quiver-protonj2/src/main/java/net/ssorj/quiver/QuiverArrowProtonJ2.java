    ...
    private static void doMain(final String[] args) throws Exception {
        ...
        if ("amqps".equals(scheme)) {
            ...
            if (cert != null && key != null) {
                // TODO: The client doesn't support pem keys at this time but could in the future if
                //       demand for it is sufficient.
                //options.setPemKeyCertOptions(new PemKeyCertOptions().setCertPath(cert).setKeyPath(key));
            }
        }
